...
def get_dict():
    ...
    for key, value in dict.items():
        ...
        dict[key]=[key, categorie, group, n_book, n_book + n_universal, xml_id]     #je nach Werk anpassen {Name der Sage: Kategorie, Gruppe, Nummer im Werk, universelle Nummer, XML-ID}
