...
"""
Set i to number
1: Trier und Umgebung
2: ...
...
"""
i = 1
if i == 1:
    MainTitle, SubTitle, Author, PublicationYear, PublicationPlace, Publisher, Edition, Copyright, encoder = initiate.trier_und_umgebung_tei_header()
else:
